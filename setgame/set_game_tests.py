...
class SetCard:
    ...
    def third_card(self, other):
        ...
        if self.fill == other.fill:
            ...
            third_fill_value = 6 - (self.fill.value + other.fill.value)
        ...
        if self.color == other.color:
            ...
            third_color_value = 6 - (self.color.value + other.color.value)
        ...
        if self.shape == other.shape:
            ...
            third_shape_value = 6 - (self.shape.value // 2 + other.shape.value // 2)
